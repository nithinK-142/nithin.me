  ...
  return (
    ...
    >
      ...
      >
        {projects.map(
          ({ name, description, techStack, logo, url, gitUrl }, index) => {
            return (
              <div
                className="flex flex-col justify-between hover:bg-neutral-100 transition-colors ease-in-out duration-300 p-4 select-none group border border-black/10 dark:border-stone-900 bg-white/40 dark:bg-neutral-800 dark:hover:bg-neutral-900/60 dark:hover:shadow-lg hover:shadow-lg relative overflow-hidden"
                key={index}
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-14">
        {/*  Honorable Mentions */}
        <div className="flex bg-white/40 dark:hover:bg-neutral-900 dark:bg-neutral-900/40 flex-col justify-between hover:bg-neutral-100 transition-colors ease-in-out duration-300 p-4 select-none group border border-black/10 dark:border-stone-900 dark:hover:shadow-lg hover:shadow-lg lg:pl-4">
        ...
        {/* Framwork Guides */}
        <div className="flex bg-white/40 dark:hover:bg-neutral-900 dark:bg-neutral-900/40 flex-col hover:bg-neutral-100 transition-colors ease-in-out duration-300 p-4 select-none group border border-black/10 dark:border-stone-900 dark:hover:shadow-lg hover:shadow-lg lg:pl-4">
